...
func main() { // nolint:gocognit
	...
	fmt.Println(encode(peerConnection.LocalDescription())) //! Do all above then give answer

	//will block execution until a value is received
	localTrack := <-localTrackChan //! go here after answer sent and ontrack run
	for {
		fmt.Println("")
