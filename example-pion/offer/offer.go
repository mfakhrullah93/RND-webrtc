...
func startHttpService(offerAddr string, answerAddr string, peerConnection *webrtc.PeerConnection, pendingCandidates []*webrtc.ICECandidate){	
	...
	panic(http.ListenAndServe(offerAddr, nil))
}
...
func main() { //nolint:gocognit
	...
	// TODO Start HTTP Service to add ICE candidates , and processes a SessionDescription (SDP offer)
	go startHttpService(*offerAddr, *answerAddr, peerConnection, pendingCandidates)
